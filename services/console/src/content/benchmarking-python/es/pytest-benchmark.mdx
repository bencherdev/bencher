...
description: "Una guía paso a paso sobre cómo realizar benchmarks en código Python con pytest-benchmark"
heading: "Cómo realizar benchmarks en código Python con pytest-benchmark"
...
¿Qué! `15.8470 us` x `1,000` debería ser `15,847.0 us` no `571,684.6334 us` 🤯
...
<CatchInCiPlotRustBench title="Cómo realizar benchmarks en Python con pytest-benchmark" />
