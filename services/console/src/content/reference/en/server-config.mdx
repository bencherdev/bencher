...
Application Performance Monitoring (APM) is a feature that allows the Bencher API Server to send telemetry to a third-party service.

|    Name    |                              Example                              | Default | Required |                                                                     Description                                                                     |
| :--------: | :---------------------------------------------------------------: | :-----: | :------: | :-------------------------------------------------------------------------------------------------------------------------------------------------: |
| sentry.dsn | "https://0123abc1023abc@987efg987efg.ingest.sentry.io/0123456789" |   ---   |    No    | Sentry [Data Source Name](https://docs.sentry.io/product/sentry-basics/dsn-explainer/). Can also be set with the `SENTRY_DSN` environment variable. |