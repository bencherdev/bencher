...
> 🐰 Iai не обновлялся [в течение нескольких лет](https://github.com/bheisler/iai/commits/main/). Поэтому вы можете рассмотреть [использование Gungraun](/ru/docs/explanation/adapters/#-rust-gungraun).
