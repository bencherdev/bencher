...
应用性能监视（APM）是一个可让 Bencher API 服务器发送遥测数据至第三方服务的功能。

|  名称  |                              例子                              | 默认值 | 必选项 |                                         说明                                         |
| :----: | :-----------------------------------------------------------: | :-----: | :----: | :---------------------------------------------------------------------------------: |
| sentry.dsn | "https://0123abc1023abc@987efg987efg.ingest.sentry.io/0123456789" |   ---   |   否   | Sentry [数据源名称](https://docs.sentry.io/product/sentry-basics/dsn-explainer/)。也可以通过 `SENTRY_DSN` 环境变量进行设置。 |