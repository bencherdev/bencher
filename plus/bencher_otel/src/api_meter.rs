...
impl ApiCounter {
    fn unit(&self) -> &'static str {
        match self {
            ...
            Self::ReplicaOversizedStalled => "{drain}",
        }
    }
    ...
    fn name(&self) -> &'static str {
        match self {
            ...
            Self::ReplicaOversizedStalled => "replica.oversized.stalled",
        }
    }
    ...
    fn description(&self) -> &'static str {
        match self {
            ...
            Self::ReplicaOversizedStalled => {
                "Counts stalled oversized-transaction drain evaluations (shipping paused, WAL growing)"
            },
        }
    }
    ...
    fn attributes(self) -> Vec<opentelemetry::KeyValue> {
        match self {
            ...
            | Self::ReplicaShadowUnverifiedBoundary
            | Self::ReplicaOversizedStalled => Vec::new(),
            Self::Run(priority)
