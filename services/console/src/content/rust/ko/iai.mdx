...
세 가지 모두 [Bencher가 지원](/docs/ko/explanation/adapters/)합니다. 그렇다면 왜 Iai를 선택하나요?
Iai는 벽시계 시간 대신 명령 수를 사용합니다.
이는 CI에서의 [지속적인 벤치마킹](/docs/ko/explanation/continuous-benchmarking/)에 이상적입니다.
...
> 🐰 Iai는 [3년 이상 업데이트되지 않았습니다](https://github.com/bheisler/iai/commits/main/). 그래서 [Iai-Callgrind를 사용](/docs/ko/explanation/adapters/#-rust-iai-callgrind)하는 것을 고려해 볼 수 있습니다.
