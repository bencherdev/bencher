...
download_binary_and_run_installer() {
    ...
    case "$_arch" in 
        "x86_64-unknown-linux-gnu")
            _artifact_name="bencher-v0.3.26-rc1-linux-x86-64"
            _zip_ext=""
            _bins="bencher"
            _bin="bencher"
            ;;
        "aarch64-unknown-linux-gnu")
            _artifact_name="bencher-v0.3.26-rc1-linux-arm-64"
            _zip_ext=""
            _bins="bencher"
            _bin="bencher"
            ;;
        "x86_64-apple-darwin")
            _artifact_name="bencher-v0.3.26-rc1-macos-x86-64"
            _zip_ext=""
            _bins="bencher"
            _bin="bencher"
            ;;
        "aarch64-apple-darwin")
            _artifact_name="bencher-v0.3.26-rc1-macos-arm-64"
            _zip_ext=""
            _bins="bencher"
            _bin="bencher"
            ;;
