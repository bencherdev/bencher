...
### Console UI
Set the `GITHUB_CLIENT_ID` environment variable when you run the `bencher-ui` Docker image. (ex: `GITHUB_CLIENT_ID=Iv1.12864abcd1232048`) If the Client ID is missing, then the GitHub buttons will not appear in the UI.
