...
use anyhow::Result;
use bencher_chrome::protocol::cdp::Browser::WindowState;
use bencher_chrome::protocol::cdp::Fetch::events::RequestPausedEvent;
use bencher_chrome::protocol::cdp::Fetch::{
    FulfillRequest, HeaderEntry, RequestPattern, RequestStage,
};
use bencher_chrome::protocol::cdp::Network::{Cookie, CookieParam};
use bencher_chrome::protocol::cdp::Page::CaptureScreenshotFormatOption;
use bencher_chrome::protocol::cdp::Runtime::{RemoteObjectSubtype, RemoteObjectType};
use bencher_chrome::protocol::cdp::DOM::RGBA;
use bencher_chrome::types::{Bounds, RemoteError};
use bencher_chrome::LaunchOptionsBuilder;
use log::*;
use rand::prelude::*;
