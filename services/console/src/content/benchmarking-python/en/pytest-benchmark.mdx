...
import FizzBuzzFibonacciOpenCode from "../../../chunks/benchmarking-python/pytest-benchmark/fizz-buzz-fibonacci-open-code.mdx";
...
The `test_game_100` benchmark is down nearly 10x, `-93.950%`.
And the `test_game_1_000_000` benchmark is down more than 10,000x! `9,596,800 ns` to `30.403 ns`!
