...
use super::{RunError, BENCHER_BRANCH};
...
impl Branch {
    pub async fn resource_id(
        ...
        dry_run: bool,
        backend: &Backend,
    ) -> Result<Option<ResourceId>, RunError> {
        Ok(match self {
