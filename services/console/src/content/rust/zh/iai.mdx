...
三者都被 [Bencher 支持](/docs/zh/explanation/adapters/)。那么为什么选择Iai呢？
Iai使用指令计数而非墙钟时间。
这使其理想的适合[持续性基准测试](/docs/zh/explanation/continuous-benchmarking/)，也就是在CI中进行基准测试。
...
> 🐰 Iai 已经超过3年没有更新了（查看 [这里](https://github.com/bheisler/iai/commits/main/)）。所以你可能需要考虑[使用 Iai-Callgrind](/docs/zh/explanation/adapters/#-rust-iai-callgrind) 替代。
