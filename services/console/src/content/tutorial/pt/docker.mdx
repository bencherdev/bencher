...
Já lhe aconteceu uma regressão de desempenho impactar os seus usuários?
O Bencher poderia ter evitado que isso acontecesse.
Bencher permite detectar e prevenir regressões de desempenho _antes_ que cheguem à produção.
...
Se estiver interessado em utilizar Bencher Cloud, confira o [tutorial de início rápido do Bencher Cloud](/docs/pt/tutorial/quick-start).
