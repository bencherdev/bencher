...
> 🐰 Iai n'a pas été mis à jour [depuis plusieurs années](https://github.com/bheisler/iai/commits/main/). Vous pouvez donc envisager d'[utiliser Gungraun](/fr/docs/explanation/adapters/#-rust-gungraun) à la place.
