...
- [Statistical Continuous Benchmarking][statistical continuous benchmarking]
  ...
  2. Use this baseline along with a [Statistical Threshold][thresholds] to create a statistical boundary
...
- [Relative Continuous Benchmarking][relative continuous benchmarking]
  ...
  4. Use a [Percentage Threshold][percentage thresholds] to create a boundary for the baseline code
