...
Diesel support [the three most popular databases][stackoverflow databases]:
...
Then [on 02 November 2020][github diesel criterion], they switched over to using [Criterion][criterion] as their benchmarking harness.
...
[github diesel criterion]: https://github.com/diesel-rs/diesel/commit/11a989d0ce626d0482939ab3edf9da1fe0591365
...
With these changes [merge into Diesel][github issue 3849],
...
Georg Semmler still had to run the benchmarks locally in order to detect a performance regression.
