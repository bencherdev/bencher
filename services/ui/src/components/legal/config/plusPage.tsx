	...
	content: (
		<div>
			...
			<p>
				...
				Subscription for the correct number of metrics. Notwithstanding the
			...
			<p>
				For all third party components incorporated into the Bencher Software,
