...
A Delta Interquartile Range Threshold (`delta-iqr`) measures how many multiples of the average percentage change (Δ) [interquartile range](https://en.wikipedia.org/wiki/Interquartile_range) (IQR)
