...
> 🐰 Tipp: Um einen CI-Build zu verfehlen, wenn eine Grenze verletzt wird, verwenden Sie die `--err` Flagge für den <code><a href="/docs/de/explanation/bencher-run">bencher run</a></code> CLI-Unterbefehl.
...
Um einen CI-Build im Falle eines Alarms zu verfehlen, setzen Sie die `--err` Flagge beim Verwenden des <code><a href="/docs/de/explanation/bencher-run">bencher run</a></code> CLI-Unterbefehls.
...
<h2><a href="/docs/de/explanation/continuous-benchmarking">Weitermachen: Kontinuierliches Benchmarking ➡</a></h2>
