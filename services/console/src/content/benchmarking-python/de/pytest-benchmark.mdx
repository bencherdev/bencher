...
description: "Eine Schritt-für-Schritt-Anleitung zum Benchmarking von Python-Code mit pytest-benchmark"
...
Beide werden von [Bencher unterstützt](/de/docs/explanation/adapters/).
...
Was! `15.8470 us` x `1,000` sollte `15,847.0 us` sein, nicht `571,684.6334 us` 🤯
...
Oh, wow! Unser `test_game` Benchmark ist wieder etwa dort, wo er ursprünglich für FizzBuzz war.
...
<CatchInCiPlotRustBench title="Wie man Python mit pytest-benchmark benchmarket" />
