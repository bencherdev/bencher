...
- [Changepoint Detection][changepoint detection]
  1. Track benchmark results over time to create a baseline
  2. Occasionally run the benchmarks for the new versions of the code
  3. Use a changepoint detection algorithm to detect performance regressions
  4. Bisection to find the commit that introduced the regression
  5. Generate an alert for the commit that introduced the regression
