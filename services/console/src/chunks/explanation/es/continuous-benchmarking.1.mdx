...
- [Evaluación relativa](/docs/es/how-to/track-benchmarks)
- Corredores de CI dedicados, como [BuildJet](https://buildjet.com)
...
<a href="https://bencher.dev/perf/bencher?key=true&metric_kind=latency&branches=619d15ed-0fbd-4ccb-86cb-fddf3124da29&tab=benchmarks&testbeds=0d991aac-b241-493a-8b0f-8d41419455d2&benchmarks=1db23e93-f909-40aa-bf42-838cc7ae05f5"><img src="https://api.bencher.dev/v0/projects/bencher/perf/img?branches=619d15ed-0fbd-4ccb-86cb-fddf3124da29&testbeds=0d991aac-b241-493a-8b0f-8d41419455d2&benchmarks=1db23e93-f909-40aa-bf42-838cc7ae05f5&metric_kind=latency&title=Embrace+the+Chaos%21" title="¡Abraza el Caos!" alt="¡Abraza el Caos! para Bencher - Bencher" /></a>
...
Ver [arte previo](/docs/es/reference/prior-art) para una lista completa de las herramientas de evaluación existentes de las que nos inspiramos.
...
Para enlaces a publicaciones relacionadas con la evaluación continua de las grandes empresas de tecnología, consulte [arte previo](/docs/es/reference/prior-art).
