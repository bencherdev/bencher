...
macro_rules! fn_get_not_deleted {
    ($table:ident, $id:ident) => {
        pub fn get(
            conn: &mut $crate::context::DbConnection,
            id: $id,
...
pub(crate) use fn_get_not_deleted;
...
macro_rules! fn_get_id_not_deleted {
    ($table:ident, $id:ident, $uuid:ident) => {
        pub fn get_id(
            conn: &mut $crate::context::DbConnection,
            uuid: $uuid,
...
pub(crate) use fn_get_id_not_deleted;
...
macro_rules! fn_get_uuid_not_deleted {
    ($table:ident, $id:ident, $uuid:ident) => {
        pub fn get_uuid(
            conn: &mut $crate::context::DbConnection,
            id: $id,
...
pub(crate) use fn_get_uuid_not_deleted;
...
macro_rules! fn_from_uuid_not_deleted {
    ($parent:ident, $parent_type:ty, $table:ident, $uuid:ident, $resource:ident) => {
        pub fn from_uuid(
            conn: &mut DbConnection,
            parent: $parent_type,
...
pub(crate) use fn_from_uuid_not_deleted;
