...
pub struct JsonReportThresholds {
    ...
    /// Reset the thresholds of the branch and testbed that the `models` field can address.
    ...
    /// The thresholds the `models` field can address are, at the report's BMF version 0,
    /// those with no parameters filter and no metric name, and at version 1, every threshold
    /// of the branch and testbed.
...
const RUST_GUNGRAUN_STDOUT_INT: i32 = 25;
const RUST_GUNGRAUN_JSON_INT: i32 = 26;
