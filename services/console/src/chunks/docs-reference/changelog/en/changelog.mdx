...
- **BREAKING CHANGE** Creating an on-the-fly project when the `CI` environment variable is set will now require the `--ci-on-the-fly` flag (Thank you [@jaqx0r](https://github.com/jaqx0r))
