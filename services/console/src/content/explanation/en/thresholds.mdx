...
The Lower Boundary must be less than or equal to the Upper Boundary, if specified.
...
The Upper Boundary must be greater than or equal to the Lower Boundary, if specified.
...
such as machine access instructions.
...
> 🐰 Using the Log Normal Distribution will only work if your data is all positive!
...
- ### Interquartile Range Threshold Lower Boundary
  - An Interquartile Range Threshold Lower Boundary can be any multiplier greater than or equal to zero in decimal form (ex: use `2.0` for `2x`).
It is used when a smaller value would indicate a performance regression.
...
- ### Interquartile Range Threshold Upper Boundary
  - An Interquartile Range Threshold Upper Boundary can be any multiplier greater than or equal to zero in decimal form (ex: use `2.0` for `2x`).
It is used when a greater value would indicate a performance regression.
...
- ### Delta Interquartile Range Threshold Lower Boundary
  - A Delta Interquartile Range Threshold Lower Boundary can be any multiplier greater than or equal to zero in decimal form (ex: use `2.0` for `2x`).
It is used when a smaller value would indicate a performance regression.
...
- ### Delta Interquartile Range Threshold Upper Boundary
  - A Delta Interquartile Range Threshold Upper Boundary can be any multiplier greater than or equal to zero in decimal form (ex: use `2.0` for `2x`).
It is used when a greater value would indicate a performance regression.
