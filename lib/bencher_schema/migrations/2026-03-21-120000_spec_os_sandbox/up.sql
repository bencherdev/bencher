...
INSERT INTO up_spec(id, uuid, name, slug, os, architecture, sandbox, cpu, memory, disk, network, fallback, created, modified, archived)
SELECT id, uuid, name, slug, 'linux', architecture, 'firecracker', cpu, memory, disk, network, fallback, created, modified, archived
FROM spec;
