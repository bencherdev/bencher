...
Eine ausführlichere Erklärung finden Sie in der [Benchmarking-Übersicht](/docs/de/explanation/benchmarking).
Sie können im <code><a href="/docs/de/explanation/bencher-run">bencher run</a></code> CLI-Unterbefehl mit der optionalen `--adapter`-Flag festgelegt werden.
...
<a href="https://bencher.dev/perf/bencher?key=true&metric_kind=latency&tab=benchmarks&testbeds=0d991aac-b241-493a-8b0f-8d41419455d2&branches=619d15ed-0fbd-4ccb-86cb-fddf3124da29&benchmarks=3525f177-fc8f-4a92-bd2f-dda7c4e15699%2C1db23e93-f909-40aa-bf42-838cc7ae05f5&start_time=1674950400000"><img style="border: 0.2em solid #ed6704;" src="https://api.bencher.dev/v0/projects/bencher/perf/img?branches=619d15ed-0fbd-4ccb-86cb-fddf3124da29&testbeds=0d991aac-b241-493a-8b0f-8d41419455d2&benchmarks=3525f177-fc8f-4a92-bd2f-dda7c4e15699%2C1db23e93-f909-40aa-bf42-838cc7ae05f5&metric_kind=latency&start_time=1674950400000&title=Benchmark+Adapter+Comparison" title="Vergleich der Benchmark-Adapter" alt="Vergleich der Benchmark-Adapter für Bencher - Bencher" /></a>
</div>
...
dann können Sie den <code><a href="/docs/de/explanation/bencher-run">bencher run</a></code> CLI-Unterbefehl mit dem optionalen `--file`-Argument verwenden, um diesen Dateipfad anzugeben.
...
Dies kann im <code><a href="/docs/de/explanation/bencher-run">bencher run</a></code> CLI-Unterbefehl mit der optionalen `--average`-Flag festgelegt werden.
...
Der C++ Google-Adapter (`cpp_google`) erwartet [Google Benchmark](https://github.com/google/benchmark) Ausgabe im [JSON-Format (d.h. `--benchmark_format=json`)](https://github.com/google/benchmark/blob/main/docs/de/user_guide.md#output-formats).
Die `latency` Metrikart (d.h. `Nanosekunden (ns)`) wird ermittelt.
...
Der JavaScript Time-Adapter (`js_time`) erwartet [console.time](https://developer.mozilla.org/en-US/docs/de/Web/API/console/time)/[console.timeEnd](https://developer.mozilla.org/en-US/docs/de/Web/API/console/timeEnd) Ausgabe.
Die `latency` Metrikart (d.h. `Nanosekunden (ns)`) wird ermittelt.
...
Dies kann im <code><a href="/docs/de/explanation/bencher-run">bencher run</a></code> CLI-Unterbefehl mit dem optionalen `--average`-Argument festgelegt werden.
...
<h2><a href="/docs/de/explanation/thresholds">Weiter geht's: Schwellenwerte & Warnungen ➡</a></h2>