...
import RustIaiCallgrind from "../../../chunks/explanation/es/adapter-rust-iai-callgrind.mdx";
...
Esto funciona tanto con un comando de referencia (ejemplo: `bencher run --file results.json "bencher mock > results.json"`)
