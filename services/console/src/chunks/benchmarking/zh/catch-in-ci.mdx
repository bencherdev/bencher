...
而在工作中需要在我们的私有云内，我已经开始使用 [Bencher Self-Hosted](/docs/zh/tutorial/docker/)。

Bencher有一个[内建的适配器](/docs/zh/explanation/adapters/)，
所以很容易集成到 CI 中。在[遵循快速开始指南](/docs/zh/tutorial/quick-start/)后，
