...
10. [Suivez vos benchmarks](/docs/fr/how-to/track-benchmarks/) avec la sous-commande CLI <code><a href="/docs/fr/explanation/bencher-run/">bencher run</a></code>:
    ...
    3. Configurez la commande pour échouer si une alerte est générée. (ex: `--err`) Pour qu'une alerte soit générée, un [Seuil](/docs/fr/explanation/thresholds/) doit déjà exister.
