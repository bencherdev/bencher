...
Bencherは[継続的ベンチマーキング](/docs/explanation/continuous-benchmarking)のツールセットです。
...
もしBencher Cloudに興味がある場合は、[ベンチャー クラウド クイックスタートチュートリアル](/docs/tutorial/quick-start)をご覧ください。
...
<h2><a href="/docs/tutorial/quick-start">続けてください：クイックスタート ➡</a></h2>
