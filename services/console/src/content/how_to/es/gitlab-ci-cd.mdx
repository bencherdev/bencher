...
1. [Rastrea tus benchmarks](/docs/es/how-to/track-benchmarks) con el subcomando CLI <code><a href="/docs/es/explanation/bencher-run">bencher run</a></code>:
    1. Hay varias opciones para establecer la rama del proyecto. Consulta [selección de rama](/docs/es/how-to/branch-selection) para una descripción completa. El comando proporcionado utiliza [variables predefinidas de GitLab CI/CD](https://docs.gitlab.com/ee/ci/variables/predefined_variables.html) e intenta:
