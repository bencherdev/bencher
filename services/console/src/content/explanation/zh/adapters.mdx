...
import RustIaiCallgrind from "../../../chunks/explanation/zh/adapter-rust-iai-callgrind.mdx";
...
这对于具有基准测试命令（例如：`bencher run --file results.json "bencher mock > results.json"`）
