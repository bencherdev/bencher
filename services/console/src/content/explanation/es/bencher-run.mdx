...
La forma más conveniente de hacer esto es utilizando la [variable de entorno `GITHUB_TOKEN`de GitHub Actions](https://docs.github.com/en/actions/security-guides/automatic-token-authentication).
