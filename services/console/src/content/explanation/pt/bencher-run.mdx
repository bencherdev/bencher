...
A forma mais conveniente de fazer isso é a [variável de ambiente `GITHUB_TOKEN` do GitHub Actions](https://docs.github.com/en/actions/security-guides/automatic-token-authentication).
