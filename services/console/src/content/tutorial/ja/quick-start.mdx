...
Bencherは[継続的なベンチマーキング](/docs/ja/explanation/continuous-benchmarking/)ツールの組です。
...
自己ホスティングに興味がある場合は、[Bencher Dockerチュートリアル](/docs/ja/tutorial/docker/)をチェックしてください。
...
> 🐰 ヒント: [`bencher run` CLIサブコマンドのドキュメント](/docs/ja/explanation/bencher-run/)をチェックして、`bencher run`ができるすべてのことを完全に把握してください！
...
> 🐰 ヒント: パフォーマンスリグレッションがどのように検出されるかの全体像を把握するため、[閾値＆アラートドキュメント](/docs/ja/explanation/thresholds/)をチェックしてください！
...
<h2><a href="/docs/ja/explanation/benchmarking">続けていく：ベンチマーキングの概要 ➡</a></h2>
