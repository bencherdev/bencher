...
[Быстром старте][quickstart] и [Локальном использовании Docker][docker self-hosted],
...
> [создали API токен и установили его в качестве переменной среды `BENCHER_API_KEY`][create an api token]!
