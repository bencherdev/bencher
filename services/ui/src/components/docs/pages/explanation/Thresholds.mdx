...
This can include a Left Side Boundary, Right Side Boundary, or both.
A Boundary Limit is calculated for each Side Boundary.
...
then a Left Side Boundary of `0.977` would create a Boundary Limit at `80.05`.
...
For example, if you used a Z-score and your historical Metrics had a mean of `100` and a standard deviation of `10`,
then a Right Side Boundary of `0.977` would create a Boundary Limit at `119.95`.
