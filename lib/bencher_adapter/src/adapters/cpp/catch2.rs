...
// fn parse_catch2(input: &str) -> IResult<&str, BenchmarkName> {
//     map_res(
//         many_till(anychar, parse_catch2_prelude),
//         |(key_chars, metric)| -> Result<BenchmarkName, nom::Err<nom::error::Error<String>>> {
//             let mut key: String = key_chars.into_iter().collect();
//             if key.is_empty() {
//                 nom::Err::Error(nom::error::make_error(key, nom::error::ErrorKind::Tag))
//             } else {
//                 Ok(key)
//             }
//         },
...
//             eof,
//         )),
//         |(_, samples, _, iterations, _, estimated, _, estimated_units, _)| Prelude {
//             samples,
//             iterations,
//             estimated,
//             estimated_units,
...
//     use super::{parse_criterion, AdapterCppCatch2};
