...
<a href="https://bencher.dev/perf/bencher?key=true&metric_kind=latency&tab=benchmarks&testbeds=0d991aac-b241-493a-8b0f-8d41419455d2&branches=619d15ed-0fbd-4ccb-86cb-fddf3124da29&benchmarks=3525f177-fc8f-4a92-bd2f-dda7c4e15699%2C1db23e93-f909-40aa-bf42-838cc7ae05f5&start_time=1674950400000"><img style="border: 0.2em solid #ed6704;" src="https://api.bencher.dev/v0/projects/bencher/perf/img?branches=619d15ed-0fbd-4ccb-86cb-fddf3124da29&testbeds=0d991aac-b241-493a-8b0f-8d41419455d2&benchmarks=3525f177-fc8f-4a92-bd2f-dda7c4e15699%2C1db23e93-f909-40aa-bf42-838cc7ae05f5&metric_kind=latency&start_time=1674950400000&title=Benchmark+Adapter+Comparison" title="Comparaison des Adaptateurs de Benchmark" alt="Comparaison des Adaptateurs de Benchmark pour Bencher - Bencher" /></a>
</div>
...
L'adaptateur C++ Google (`cpp_google`) attend la sortie de [Google Benchmark](https://github.com/google/benchmark) au [format JSON (c'est-à-dire `--benchmark_format=json`)](https://github.com/google/benchmark/blob/main/docs/fr/user_guide.md#output-formats).
Le type de mesure `latence` (c'est-à-dire `nanosecondes (ns)`) est recueilli.
...
L'adaptateur JavaScript Time (`js_time`) attend la sortie de [console.time](https://developer.mozilla.org/en-US/docs/fr/Web/API/console/time)/[console.timeEnd](https://developer.mozilla.org/en-US/docs/fr/Web/API/console/timeEnd).
Le type de mesure `latence` (c'est-à-dire `nanosecondes (ns)`) est recueilli.
