...
1. 使用 <code><a href="/docs/zh/explanation/bencher-run/">bencher run</a></code> CLI 子命令
...
[quick start]: /docs/zh/tutorial/quick-start/
[docker self-hosted]: /docs/zh/tutorial/docker/
[continuous benchmarking]: /docs/zh/explanation/continuous-benchmarking/
[create an api token]: /docs/zh/tutorial/quick-start/#create-an-api-token
[testbed create]: /docs/zh/api/projects/testbeds/#post-v0projectsprojecttestbeds
[thresholds]: /docs/zh/explanation/thresholds/
[threshold create]: /docs/zh/api/projects/thresholds/#post-v0projectsprojectthresholds
[measure]: /docs/zh/explanation/benchmarking/#measures
[t-test]: /docs/zh/explanation/thresholds/#t-test-thresholds
[t-test upper boundary]: /docs/zh/explanation/thresholds/#t-test-threshold-upper-boundary
[github actions]: /docs/zh/how-to/github-actions/
[gitlab ci/cd]: /docs/zh/how-to/gitlab-ci-cd/
[bencher run]: /docs/zh/explanation/bencher-run/
[project option]: /docs/zh/explanation/bencher-run/#--project-project
[branch selection branch]: /docs/zh/explanation/branch-selection/#--branch-branch
[testbed option]: /docs/zh/explanation/bencher-run/#--testbed-testbed
[adapters]: /docs/zh/explanation/adapters/
[alerts]: /docs/zh/explanation/thresholds/#alerts
[command argument]: /docs/zh/explanation/bencher-run/#benchmark-command
[branch selection start point]: /docs/zh/explanation/branch-selection/#--branch-start-point-branch
[branch selection start point hash]: /docs/zh/explanation/branch-selection/#--branch-start-point-hash-hash