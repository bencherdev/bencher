...
Sustituye el `slug` de tu Organización por el argumento `organization` (es decir, `YOUR_ORG_SLUG`) en el comando de abajo.
...
Toma nota del campo `slug` del Proyecto (es decir, `save-walter-white-1234abcd`).