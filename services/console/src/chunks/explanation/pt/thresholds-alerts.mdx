...
Para falhar uma construção CI no caso de um alerta, defina a flag `--err` ao usar o subcomando CLI <code><a href="/pt/docs/explanation/bencher-run/">bencher run</a></code>.
