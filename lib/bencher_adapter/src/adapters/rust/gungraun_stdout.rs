...
pub struct AdapterRustGungraunStdout;

impl Adaptable for AdapterRustGungraunStdout {
...
#[cfg(test)]
pub(crate) mod test_rust_gungraun_stdout {
    ...
    use super::AdapterRustGungraunStdout;
    ...
    fn without_optional_metrics() {
        ...
        validate_adapter_rust_gungraun_stdout(&results, &OptionalMetrics::default());
    }
    ...
    fn with_dhat() {
        ...
        validate_adapter_rust_gungraun_stdout(
            &results,
            &OptionalMetrics {
                dhat: true,
                ..Default::default()
    ...
    fn delta() {
        let results =
            convert_file_path::<AdapterRustGungraunStdout>("./tool_output/rust/gungraun/delta.txt");
    ...
    fn with_ge() {
        let results = convert_file_path::<AdapterRustGungraunStdout>(
            "./tool_output/rust/gungraun/with-ge.txt",
        );
    ...
    fn drd() {
        ...
        let results =
            convert_file_path::<AdapterRustGungraunStdout>("./tool_output/rust/gungraun/drd.txt");
    ...
    pub fn validate_adapter_rust_gungraun_stdout(
