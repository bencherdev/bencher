...
C++ Google 어댑터(`cpp_google`)는 [Google Benchmark](https://github.com/google/benchmark) 출력을 [JSON 포맷(즉, `--benchmark_format=json`)](https://github.com/google/benchmark/blob/main/docs/ko/user_guide.md#output-formats)으로 기대합니다.
`latency` Metric Kind(즉, `나노초 (ns)`)이 수집됩니다.
...
JavaScript Time 어댑터(`js_time`)는 [console.time](https://developer.mozilla.org/en-US/docs/ko/Web/API/console/time)/[console.timeEnd](https://developer.mozilla.org/en-US/docs/ko/Web/API/console/timeEnd) 출력을 기대합니다.
`latency` Metric Kind(즉, `나노초 (ns)`)이 수집됩니다.
