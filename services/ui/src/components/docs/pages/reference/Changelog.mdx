## `v0.2.41`
- Move public perf plot images from a screenshot to server side rendering
- Add a share mechanism to public perf plot pages
...
- Moved the plot key to below the plot all the time in preperation for screenshots/embedding
