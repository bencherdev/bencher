## Pending `v0.4.3`
- **BREAKING CHANGE** Limit branch names to 256 characters and all slug lengths to 64 characters. Any existing values greater than these new limits are set to the UUID.
