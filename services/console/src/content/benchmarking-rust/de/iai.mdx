...
> 🐰 Iai wurde seit [mehreren Jahren](https://github.com/bheisler/iai/commits/main/) nicht mehr aktualisiert. Es könnte daher sinnvoll sein, stattdessen [Gungraun zu verwenden](/de/docs/explanation/adapters/#-rust-gungraun).
