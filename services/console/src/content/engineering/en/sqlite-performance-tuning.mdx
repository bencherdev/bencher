...
As of 06 April 2024 these were the table sizes:
...
This isn't the most ideal solution space wise.
In theory, I'm now storing two copies of the two largest tables in the database.
However, this only lead to a 4% increase in the actual size of the database: 83.1 MB to 86.8 MB.
...
Here I'll even give you anchor tag. Click it and then hit refresh.
...
Now, I'm sure you're impressed.
Either that was way faster than 38.8 seconds, or I'm the master of space and time!
There is still something that is bothering me though.
Why did it take things getting this bad for me to notice?
I knew that the Perf query was a critical part of the Bencher API,
and yet I didn't have anything protecting me.
...
and [load testing is different than benchmarking][continuous benchmarking].
I have a bit of hesitation adding HTTP harnesses as the line between HTTP benchmarking and HTTP load testing seems small to non-existent. Bencher is not currently designed to handle the use case of load testing very well.


Is this something that should have been caught with Continuous 
So I have added a new benchmark to the Bencher Continuous Benchmarking suite 



[bencher perf]: /perf/bencher
[adapters]: /docs/explanation/adapters/
[continuous benchmarking]: /docs/explanation/continuous-benchmarking/#continuous-benchmarking-vs-continuous-load-testing
