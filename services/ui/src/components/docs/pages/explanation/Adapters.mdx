...
They can be specified in the <code><a href="/docs/reference/bencher-run">bencher run</a></code> CLI subcommand with the optional `--adapter` flag.
...
then you can use the <code><a href="/docs/reference/bencher-run">bencher run</a></code> CLI subcommand with the optional `--file` argument to specify that file path
...
This can be specified in the <code><a href="/docs/reference/bencher-run">bencher run</a></code> CLI subcommand with the optional `--average` flag.
...
This can be specified in the <code><a href="/docs/reference/bencher-run">bencher run</a></code> CLI subcommand with the optional `--average` argument.
