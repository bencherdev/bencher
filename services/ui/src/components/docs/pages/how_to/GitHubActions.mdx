...
1. There are a few options for setting the project branch. See [branch selection](/docs/how-to/cli-branch-selection) for a full overview. (ex: `--if-branch $GITHUB_REF_NAME`)
