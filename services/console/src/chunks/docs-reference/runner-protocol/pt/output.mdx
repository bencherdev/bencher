...
Após a saída ser armazenada, o servidor executa o [adaptador de harness de benchmark][adapters] sobre os resultados
para analisar Metrics e Alerts no Report, transicionando o Job para `processed`.

A saída é retornada quando um Job é consultado com a [API `GET /v0/projects/{project}/jobs/{job}`][job query api].
...
[job query api]: /pt/docs/api/projects/jobs/#get-v0projectsprojectjobsjob
