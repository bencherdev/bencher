...
Hay [muchas formas de escribir la secuencia de Fibonacci](https://rosettacode.org/wiki/Fibonacci_sequence) y de igual forma muchas maneras de detectar un número de Fibonacci.
