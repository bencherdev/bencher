...
At each stop along with way, I'll discuss how we got here and rate how each innovation token was spent.
...
While they may work great for some projects, there was one major sticking point I just couldn't get over: [JavaScript Interoperation][js ffi].
...
This implementation was a single-page app (SPA).
...
At the time, SolidStart was very young, and I couldn't get it to meet all of my needs.
...
Honestly, this wasn't _too_ bad.
