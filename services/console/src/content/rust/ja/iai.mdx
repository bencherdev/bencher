...
すべてが[ベンチャーによってサポートされています](/docs/ja/explanation/adapters/)。なぜIaiを選ぶのでしょうか？
Iaiは壁掛け時間ではなく、命令数を使用します。
これは、CIでのベンチマーク、つまり[連続的なベンチマーキング](/docs/ja/explanation/continuous-benchmarking/)に理想的です。
...
> 🐰 Iaiは[3年以上更新されていません](https://github.com/bheisler/iai/commits/main/)。そのため、代わりに[Iai-Callgrindの使用](/docs/ja/explanation/adapters/#-rust-iai-callgrind)を検討することができます。
