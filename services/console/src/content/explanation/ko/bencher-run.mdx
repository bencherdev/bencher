...
이를 하는 가장 편리한 방법은 [GitHub Actions `GITHUB_TOKEN` 환경 변수](https://docs.github.com/en/actions/security-guides/automatic-token-authentication)입니다.
...
선택사항: 주어진 초 수 후에 요청을 재시도합니다. 기본값은 `3`입니다.
