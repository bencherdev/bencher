...
5. Définissez [les autorisations pour le `GITHUB_TOKEN`][github token permissions]
...
9. Utilisez la sous-commande CLI `bencher archive` pour archiver la branche PR.
   (ex: `bencher archive`)
