...
> 🐰 Consejo: Para hacer fallar una compilación CI cuando un límite es violado usa la bandera `--err` para el comando de la interfaz de línea de comandos <code><a href="/docs/es/explanation/bencher-run">bencher run</a></code>.
...
Para hacer fallar una compilación CI en el caso de una Alerta, establece la bandera `--err` cuando utilices el comando de línea de comandos de  <code><a href="/docs/es/explanation/bencher-run">bencher run</a></code>.
...
<h2><a href="/docs/es/explanation/continuous-benchmarking">Sigue Adelante: Benchmarking Continuo ➡</a></h2>
