...
Ersetzen Sie Ihren Organisations-`slug` durch das Argument `organization` (dh `YOUR_ORG_SLUG`) im unten stehenden Befehl.
...
Notieren Sie sich das Projekt `slug` Feld (z.B. `save-walter-white-1234abcd`).