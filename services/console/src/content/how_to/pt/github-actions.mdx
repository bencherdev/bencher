...
10. [Rastreie seus benchmarks](/docs/pt/how-to/track-benchmarks/) com o subcomando `bencher run` do CLI:
    ...
    3.  Configure o comando para falhar se um Alerta for gerado. (ex: `--err`) Para que um Alerta seja gerado, um [Limiar](/docs/pt/explanation/thresholds/) já deve existir.
