...
See [suppressing alerts][suppressing alerts] for a full overview.

If you are using [Bencher Metric Format (BMF)][bmf] the name, slug, or UUID can be used to identify a Benchmark.
