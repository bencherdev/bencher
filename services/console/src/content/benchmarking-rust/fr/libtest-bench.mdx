...
import FizzBuzzRustCode from "../../../chunks/benchmarking-rust/fizz-buzz-rust-code.mdx";
...
import RustToolchainRustBenchCode from "../../../chunks/benchmarking-rust/bench/rust-toolchain-rust-bench-code.mdx";
import RustToolchainRustBenchTree from "../../../chunks/benchmarking-rust/bench/rust-toolchain-rust-bench-tree.mdx";
import FizzBuzzRefactorRust from "../../../chunks/benchmarking-rust/bench/fr/fizz-buzz-refactor-rust.mdx";
import TestCreateRustBenchCode from "../../../chunks/benchmarking-rust/bench/test-crate-rust-bench-code.mdx"
import BenchPlayGameRustBenchCode from "../../../chunks/benchmarking-rust/bench/bench-play-game-rust-bench-code.mdx";
import BenchPlayGameRustBenchOutput from "../../../chunks/benchmarking-rust/bench/bench-play-game-rust-bench-output.mdx";
import FizzBuzzFibonacciRust from "../../../chunks/benchmarking-rust/fr/fizz-buzz-fibonacci-rust.mdx";
import PlayGameRustCode from "../../../chunks/benchmarking-rust/bench/play-game-rust-code.mdx";
import BenchPlayGameFibonacciRustBenchOutput from "../../../chunks/benchmarking-rust/bench/bench-play-game-fibonacci-rust-bench-output.mdx";
import FizzBuzzFibonacciOpenRust from "../../../chunks/benchmarking-rust/fr/fizz-buzz-fibonacci-open-rust.mdx";
import FizzBuzzFibonacciOpenRustCode from "../../../chunks/benchmarking-rust/bench/fizz-buzz-fibonacci-open-rust-code.mdx";
import TheEnd from "../../../chunks/benchmarking/fr/the-end.mdx";
import OnFire from "../../../chunks/benchmarking/fr/on-fire.mdx";
import BenchPlayGameOnFireRustBenchCode from "../../../chunks/benchmarking-rust/bench/bench-play-game-on-fire-rust-bench-code.mdx";
import BenchPlayGameOnFireRustBenchOutputStart from "../../../chunks/benchmarking-rust/bench/bench-play-game-on-fire-rust-bench-output-start.mdx";
import BenchPlayGameOnFireRustBenchOutput from "../../../chunks/benchmarking-rust/bench/bench-play-game-on-fire-rust-bench-output.mdx";
import FizzBuzzFibonacciFixRust from "../../../chunks/benchmarking-rust/fr/fizz-buzz-fibonacci-fix-rust.mdx";
import BenchPlayGameFixRustBenchOutput from "../../../chunks/benchmarking-rust/bench/bench-play-game-fix-rust-bench-output.mdx";
import CatchInCi from "../../../chunks/benchmarking/fr/catch-in-ci.mdx";
import CatchInCiRustBenchOutput from "../../../chunks/benchmarking-rust/bench/catch-in-ci-rust-bench-output.mdx";
...
Tous trois sont [supportés par Bencher](/fr/docs/explanation/adapters/). Alors pourquoi choisir le banc d'essai libtest ?
