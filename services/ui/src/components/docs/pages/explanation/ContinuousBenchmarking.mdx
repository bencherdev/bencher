...
You might look at this graph and think, "Wow, that's crazy!" But ask yourself, can your current development process detect a factor of two or even a factor of ten performance regression before it effects your users? Probably not! Now _that_ is crazy!
