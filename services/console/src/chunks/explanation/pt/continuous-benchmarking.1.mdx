...
- [Benchmarking Relativo](/docs/pt/how-to/track-benchmarks)
- Runners de CI dedicados, como o [BuildJet](https://buildjet.com)
...
<a href="https://bencher.dev/perf/bencher?key=true&metric_kinds=4358146b-b647-4869-9d24-bd22bb0c49b5&branches=619d15ed-0fbd-4ccb-86cb-fddf3124da29&tab=benchmarks&testbeds=0d991aac-b241-493a-8b0f-8d41419455d2&benchmarks=1db23e93-f909-40aa-bf42-838cc7ae05f5"><img src="https://api.bencher.dev/v0/projects/bencher/perf/img?branches=619d15ed-0fbd-4ccb-86cb-fddf3124da29&testbeds=0d991aac-b241-493a-8b0f-8d41419455d2&benchmarks=1db23e93-f909-40aa-bf42-838cc7ae05f5&metric_kinds=4358146b-b647-4869-9d24-bd22bb0c49b5&title=Embrace+the+Chaos%21" title="Aceite o Caos!" alt="Aceite o Caos! para Bencher - Bencher" /></a>
...
Veja a [arte anterior](/docs/pt/reference/prior-art) para uma lista abrangente das ferramentas de benchmarking existentes que nos inspiraram.
...
Para links para posts relacionados ao benchmarking contínuo de Grandes Empresas de Tecnologia, veja a [arte anterior](/docs/pt/reference/prior-art).
