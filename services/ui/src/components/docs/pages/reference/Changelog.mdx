...
- Add Java JMH `java_jmh` adapter and `throughput` as a new default metric kind with `operations / second (ops/s)` as units
...
- Two new C++ adapters for [Google Benchmark](https://github.com/google/benchmark) and [Catch2](https://github.com/catchorg/Catch2)
- Add an adapter for [go test -bench](https://pkg.go.dev/testing#hdr-Benchmarks)
