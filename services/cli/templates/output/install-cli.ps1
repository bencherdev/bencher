...
param (
    ...
    [string]$ArtifactDownloadUrl = 'https://bencher.dev/download/0.4.20',
...
function Install-Binary($install_args) {
  ...
  $platforms = @{
    "x86_64-pc-windows-msvc" = @{
      "artifact_name" = "bencher-v0.4.20-windows-x86-64.exe"
      "zip_ext" = ""
      "bins" = "bencher"
      "bin" = "bencher"
    }
    "aarch64-pc-windows-msvc" = @{
      "artifact_name" = "bencher-v0.4.20-windows-arm-64.exe"
      "zip_ext" = ""
      "bins" = "bencher"
      "bin" = "bencher"
    }
