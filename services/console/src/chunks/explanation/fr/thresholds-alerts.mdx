...
Pour échouer une construction CI en cas d'alerte, définissez le drapeau `--err` lors de l'utilisation de la sous-commande CLI <code><a href="/fr/docs/explanation/bencher-run/">bencher run</a></code>.
