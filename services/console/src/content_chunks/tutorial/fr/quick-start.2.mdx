...
```
$ bencher run --project sauver-walter-white-12345 "bencher mock"
{
  "bencher::mock_0": {
    "latency": {
...
View results:
- bencher::mock_0: https://bencher.dev/console/projects/sauver-walter-white-12345/perf?metric_kind=latency&branches=95521eff-09fa-4c02-abe1-dd824108869d&testbeds=5b4a6f3e-a27d-4cc3-a2ce-851dc6421e6e&benchmarks=88375e7c-f1e0-4cbb-bde1-bdb7773022ae
- bencher::mock_1: https://bencher.dev/console/projects/sauver-walter-white-12345/perf?metric_kind=latency&branches=95521eff-09fa-4c02-abe1-dd824108869d&testbeds=5b4a6f3e-a27d-4cc3-a2ce-851dc6421e6e&benchmarks=e81c7863-cc4b-4e22-b507-c1e238871137
(...)
```
...
Cliquez ou copiez et collez les liens de `Voir les résultats`.
...
Exécutez : `export BENCHER_PROJECT=sauver-walter-white-12345`
...
> 🐰 Astuce : Consultez la documentation de la sous-commande CLI [`bencher run`](/docs/explication/bencher-run) pour un aperçu complet de tout ce que peut faire `bencher run` !
...
Il devrait y avoir une nouvelle section à la fin de la sortie appelée `Voir les alertes` :

```
Voir les alertes :
- bencher::mock_0: https://bencher.dev/console/projects/sauver-walter-white-12345/alertes/b2329d5a-4471-48ab-bfbd-959d46ba1aa6
- bencher::mock_1: https://bencher.dev/console/projects/sauver-walter-white-12345/alertes/181b1cf5-d984-402a-b0f1-68f6f119fa66
- bencher::mock_2: https://bencher.dev/console/projects/sauver-walter-white-12345/alertes/b9b6c904-c657-4908-97db-dbeca40f8782
- bencher::mock_3: https://bencher.dev/console/projects/sauver-walter-white-12345/alertes/5567ff32-2829-4b6a-969a-af33ce3828db
- bencher::mock_4: https://bencher.dev/console/projects/sauver-walter-white-12345/alertes/49f2768f-ccda-4933-8e1d-08948f57a74d
```

<br />

Vous pouvez maintenant visualiser les alertes pour chaque banc d'essai dans le navigateur.
Cliquez ou copiez et collez les liens de `Vue des alertes`.

<br />

> 🐰 Astuce : Consultez la documentation sur les [Seuils et alertes](/docs/explication/seuils) pour un aperçu complet de la façon dont les régressions de performance sont détectées !
...
<h2><a href="/docs/explication/benchmarking">Continuer : Vue d'ensemble du benchmarking ➡</a></h2>

<div class="box" style="margin-top: 4rem;">Ce document a été généré automatiquement par OpenAI GPT-4. Il peut ne pas être précis et peut contenir des erreurs. Si vous trouvez des erreurs, veuillez <a href="https://github.com/bencherdev/bencher/issues/new?title=Issue+avec+la+traduction+en+français&body=Problème+avec+la+traduction+en+français+pour+tutorial%2Fen%2Fquick-start-b.mdx.&labels=documentation" target="_blank">ouvrir une issue sur GitHub</a>.</div>
