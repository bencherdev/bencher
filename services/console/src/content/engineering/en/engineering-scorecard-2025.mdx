...
A tool should love their heavy users, not punish them.
...
With that said though, I have found deploying to Fly.io to be mostly pleasant.
They did have a couple of major outages which took Bencher down for half-a-day each time.
In the future when I switch to Kamal, I'll also be moving off of Fly.io.
Between the outages and the ever increasing bills as they meter more and more things
I don't think Bencher Cloud really fits their use case.

The [AWS S3][aws s3] backend for the Litestream replication has been 
