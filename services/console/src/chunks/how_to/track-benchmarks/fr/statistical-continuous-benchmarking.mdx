...
1. Utilisez la sous-commande CLI <code><a href="/docs/fr/explanation/bencher-run/">bencher run</a></code>
...
[quick start]: /docs/fr/tutorial/quick-start/
[docker self-hosted]: /docs/fr/tutorial/docker/
[continuous benchmarking]: /docs/fr/explanation/continuous-benchmarking/
[create an api token]: /docs/fr/tutorial/quick-start/#create-an-api-token
[testbed create]: /docs/fr/api/projects/testbeds/#post-v0projectsprojecttestbeds
[thresholds]: /docs/fr/explanation/thresholds/
[threshold create]: /docs/fr/api/projects/thresholds/#post-v0projectsprojectthresholds
[measure]: /docs/fr/explanation/benchmarking/#measures
[t-test]: /docs/fr/explanation/thresholds/#t-test-thresholds
[t-test upper boundary]: /docs/fr/explanation/thresholds/#t-test-threshold-upper-boundary
[github actions]: /docs/fr/how-to/github-actions/
[gitlab ci/cd]: /docs/fr/how-to/gitlab-ci-cd/
[bencher run]: /docs/fr/explanation/bencher-run/
[project option]: /docs/fr/explanation/bencher-run/#--project-project
[branch selection branch]: /docs/fr/explanation/branch-selection/#--branch-branch
[testbed option]: /docs/fr/explanation/bencher-run/#--testbed-testbed
[adapters]: /docs/fr/explanation/adapters/
[alerts]: /docs/fr/explanation/thresholds/#alerts
[command argument]: /docs/fr/explanation/bencher-run/#benchmark-command
[branch selection start point]: /docs/fr/explanation/branch-selection/#--branch-start-point-branch
[branch selection start point hash]: /docs/fr/explanation/branch-selection/#--branch-start-point-hash-hash