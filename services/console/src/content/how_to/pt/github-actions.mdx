...
Também é _muito_ importante envolver o nome do branch do PR (head ref) em **simples** aspas. (ex: `'${{ github.head_ref }}'`) Caso contrário, um invasor poderia criar um branch com um nome malicioso que realiza uma injeção de comando. Veja este [artigo do GitHub Security Lab](https://securitylab.github.com/research/github-actions-untrusted-input/) sobre como prevenir solicitações pwn de entrada não confiável para uma visão geral completa.
