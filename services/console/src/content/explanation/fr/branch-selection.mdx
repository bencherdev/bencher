...
Il existe plusieurs façons de définir la branche de projet dans la sous-commande <code><a href="/fr/docs/explanation/bencher-run/">bencher run</a></code> CLI.
...
<h2><a href="/fr/docs/explanation/adapters/">Continuer : Adaptateurs de Harnais de Benchmark ➡</a></h2>
