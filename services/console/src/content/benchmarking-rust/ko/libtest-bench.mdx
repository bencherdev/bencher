...
import FizzBuzzRefactorRust from "../../../chunks/benchmarking-rust/bench/ko/fizz-buzz-refactor-rust.mdx";
...
이 세 가지는 모두 [Bencher가 지원합니다](/ko/docs/explanation/adapters/). 그렇다면 왜 libtest bench를 선택해야 할까요?
