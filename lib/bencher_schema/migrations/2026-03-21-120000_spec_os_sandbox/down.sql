...
INSERT INTO down_spec(id, uuid, name, slug, architecture, cpu, memory, disk, network, fallback, created, modified, archived)
SELECT id, uuid, name, slug, architecture, cpu, memory, disk, network, fallback, created, modified, archived
FROM spec;
