...
import FizzBuzzRefactorRust from "../../../chunks/benchmarking-rust/bench/pt/fizz-buzz-refactor-rust.mdx";
...
Todos os três são [suportados pelo Bencher](/pt/docs/explanation/adapters/). Então, por que escolher o libtest bench?
