...
Alle drei werden [unterstützt von Bencher](/docs/de/explanation/adapters/). Warum also Iai wählen?
Iai verwendet Anweisungszähler statt Echtzeit.
Das macht es ideal für [dauerndes Benchmarking](/docs/de/explanation/continuous-benchmarking/), also Benchmarking in CI.
...
> 🐰 Iai wurde [seit über 3 Jahren nicht mehr aktualisiert](https://github.com/bheisler/iai/commits/main/). Daher könnten Sie in Betracht ziehen, [Iai-Callgrind](/docs/de/explanation/adapters/#-rust-iai-callgrind) zu verwenden.
