...
Existem algumas maneiras de configurar a branch do projeto no subcomando CLI <code><a href="/pt/docs/explanation/bencher-run/">bencher run</a></code>.
...
<h2><a href="/pt/docs/explanation/adapters/">Continue: Adaptadores de Teste de Desempenho ➡</a></h2>
