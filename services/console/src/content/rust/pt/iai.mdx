...
Todos três são [suportados pelo Bencher](/docs/pt/explanation/adapters/). Então por que escolher o Iai?
O Iai usa contagens de instrução em vez do tempo real.
Isso o torna ideal para [benchmark contínuo](/docs/pt/explanation/continuous-benchmarking/), ou seja, benchmarking em CI.
...
> 🐰 O Iai não tem atualização [há mais de 3 anos](https://github.com/bheisler/iai/commits/main/). Então você pode considerar [usar o Iai-Callgrind](/docs/pt/explanation/adapters/#-rust-iai-callgrind) em vez dele.
