...
Everything worked fine when I was prototyping,
but when Bencher started to have users 


Going "all-in" on Solid also influenced my decision on which hosting provider to use.
Around the time that I was researching 
