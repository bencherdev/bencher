...
fn busybox_sha256() -> anyhow::Result<&'static str> {
    use std::env::consts::ARCH;
    match ARCH {
        "x86_64" => Ok("6e123e7f3202a8c1e9b1f94d8941580a25135382b99e8d3e34fb858bba311348"),
        "aarch64" => Ok("65643147a622ddf4689ade5f66a21f7cafb378ec595b4da3cd78c21412bf2230"),
        arch => anyhow::bail!("Unsupported architecture: {arch}"),
    }
}
