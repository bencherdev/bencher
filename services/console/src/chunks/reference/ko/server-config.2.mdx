...
Application Performance Monitoring (APM)은 Bencher API 서버가 텔레메트리를 제3자 서비스에 보낼 수 있게 하는 기능입니다.

|    이름    |                               예제                                | 기본값 | 필수 여부 |                                                                  설명                                                                  |
| :--------: | :---------------------------------------------------------------: | :----: | :-------: | :------------------------------------------------------------------------------------------------------------------------------------: |
| sentry.dsn | "https://0123abc1023abc@987efg987efg.ingest.sentry.io/0123456789" |  ---   |  아니오   | Sentry [데이터 소스 이름](https://docs.sentry.io/product/sentry-basics/dsn-explainer/). `SENTRY_DSN` 환경 변수로도 설정할 수 있습니다. |
