...
then you tracked benchmarks from your local development environment.
Bencher does not require you to create an account in order to track benchmarks you run locally.
...
There are a few ways to claim a Project:
