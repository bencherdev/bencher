...
- General
  ...
  - [hyperfine](https://github.com/sharkdp/hyperfine)/[chronologer](https://github.com/dandavison/chronologer) - A command-line benchmarking tool/visualize performance benchmarks over git commit history
- Framework Specific
...
> Some of their test files are used for our [CLI Adapters](https://bencher.dev/docs/explanation/cli-adapters).
