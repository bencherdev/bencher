...
import FizzBuzzRefactorRust from "../../../chunks/benchmarking-rust/bench/de/fizz-buzz-refactor-rust.mdx";
...
Alle drei werden von [Bencher unterstützt](/de/docs/explanation/adapters/). Warum also libtest bench wählen?
