import PullRequestsForkTrackCode from "../chunks/page/es/pull-requests-fork-track-code.mdx";
...
19. Establece el flag `--err` para que el comando falle si se genera una Alerta.
