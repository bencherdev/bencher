...
The primary use case for `--branch-reset` is [Relative Continuous Benchmarking](/docs/how-to/track-benchmarks/#relative-continuous-benchmarking).
This flag conflicts with the [`--branch-start-point`](#--branch-start-point-branch) option.
