...
> 🐰 Iai no se ha actualizado [en varios años](https://github.com/bheisler/iai/commits/main/). Así que podrías considerar [usar Gungraun](/es/docs/explanation/adapters/#-rust-gungraun) en su lugar.
