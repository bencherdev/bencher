...
import FizzBuzzRefactorRust from "../../../chunks/benchmarking-rust/bench/zh/fizz-buzz-refactor-rust.mdx";
...
所有这三个都是[由Bencher支持](/zh/docs/explanation/adapters/)。那么为什么要选择libtest bench呢?
