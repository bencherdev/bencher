...
import FizzBuzzRefactorRust from "../../../chunks/benchmarking-rust/bench/ja/fizz-buzz-refactor-rust.mdx";
...
すべてが [Bencherによってサポートされています](/ja/docs/explanation/adapters/)。では、なぜlibtest benchを選ぶのでしょうか？
