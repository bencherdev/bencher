...
import GitHubActions2Label from "../../../chunks/how_to/github-actions.2.xlabel.mdx";
...
Instead explicitly pass in the API token to `bencher run` using [the GitHub context token](https://docs.github.com/en/actions/learn-github-actions/contexts#github-context) (ex: `--token ${{ secrets.GITHUB_TOKEN }}`).
