...
Der bequemste Weg, dies zu tun, ist die [GitHub Actions `GITHUB_TOKEN` Umgebungsvariable](https://docs.github.com/en/actions/security-guides/automatic-token-authentication).
