...
Bencher는 [지속적인 벤치마킹](/docs/ko/explanation/continuous-benchmarking) 도구 모음입니다.
...
자체 호스팅에 관심이 있다면, [Bencher Docker 튜토리얼](/docs/ko/tutorial/docker)을 확인하세요.
...
> 🐰 팁: [`bencher run` CLI 서브커맨드 문서](/docs/ko/explanation/bencher-run)에서 `bencher run`이 할 수 있는 모든 것에 대한 전체 개요를 확인하세요!
...
> 🐰 팁: 성능 성하위가 어떻게 검출되는지에 대한 전체 개요를 보려면 [임계값 & 알림 문서](/docs/ko/explanation/thresholds)를 확인하세요!
...
<h2><a href="/docs/ko/explanation/benchmarking">계속 진행: 벤치마킹 개요 ➡</a></h2>
