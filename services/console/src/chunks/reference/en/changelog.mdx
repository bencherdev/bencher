## Pending `v0.3.22`
- Update all `PUT` API endpoints with immediate update semantics to return a `200` status code
- Update all `PATCH` API endpoints with immediate update semantics to return a `200` status code
