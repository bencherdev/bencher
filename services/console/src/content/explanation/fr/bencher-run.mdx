...
La manière la plus commode de faire ceci est la [variable d'environnement `GITHUB_TOKEN` de GitHub Actions](https://docs.github.com/en/actions/security-guides/automatic-token-authentication).
