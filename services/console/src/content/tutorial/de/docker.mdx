...
import { DisclosureDe } from "../../../chunks/disclosure.tsx"

## Was ist Bencher?

Bencher ist eine Suite von [kontinuierlichen Benchmarking](/docs/de/explanation/continuous-benchmarking) Werkzeugen.
...
Wenn Sie an der Nutzung von Bencher Cloud interessiert sind, schauen Sie sich das [Bencher Cloud Quick Start Tutorial](/docs/de/tutorial/quick-start) an.
...
<h2><a href="/docs/de/tutorial/quick-start">Weitermachen: Quick Start ➡</a></h2>

<DisclosureDe page="Docker+tutorial" />
