...
- Des exécutants de CI dédiés, comme [BuildJet](https://buildjet.com)
...
Voir [art antérieur](/docs/fr/reference/prior-art) pour une liste complète des outils de benchmarking existants dont nous nous sommes inspirés.
...
Pour des liens vers des articles liés au benchmarking continu en provenance de grandes technologies, voir [art antérieur](/docs/fr/reference/prior-art).
