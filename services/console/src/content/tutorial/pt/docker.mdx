...
Bencher é um conjunto de ferramentas de [benchmarking contínuo](/docs/explanation/continuous-benchmarking).
...
Se estiver interessado em utilizar Bencher Cloud, confira o [tutorial de início rápido do Bencher Cloud](/docs/tutorial/quick-start).
...
<h2><a href="/docs/tutorial/quick-start">Continue: Início Rápido ➡</a></h2>
